...
namespace Swinburneexplorer
{
	...
	public static class GameResources
	{
		...
		private static void LoadLocations() {
            ...
            _locations.Add("toBurwood1", new Location("toBurwood1"));
            _locations.Add("toBurwood2", new Location("toBurwood2"));
            _locations.Add("toBurwood3", new Location("toBurwood3"));
            ...
            _locations.Add("toLodges7", new Location("toLodges7"));
            _locations.Add("toLodges8", new Location("toLodges8"));
            _locations.Add("toLodges9", new Location("toLodges9"));
            ...
            _locations.Add("toSouthSide5", new Location("toSouthSide5"));
            ...
            _locations.Add("toTrain9.5", new Location("toTrain9.5"));
            ...
            _locations.Add("toTrain17", new Location("toTrain17"));
		...
		private static void ConfigureLocations() {
            ...
            GetLocation("toTrain8").AddConnectingLocation(GetLocation("toTrain16"), FORWARD);
            ...
            //toTrain9.5
            GetLocation("toTrain9.5").AddConnectingLocation(GetLocation("toTrain9"), FORWARD);
            GetLocation("toTrain9.5").AddConnectingLocation(GetLocation("toTrain11"), LEFT);

            //toTrain10
            GetLocation("toTrain10").AddConnectingLocation(GetLocation("toTrain11"), FORWARD);
			GetLocation("toTrain10").AddConnectingLocation(GetLocation("toTrain9.5"), RIGHT);
            ...
            GetLocation("toTrain15").AddConnectingLocation(GetLocation("toTrain9.5"), LEFT);

            //toTrain16
            GetLocation("toTrain16").AddConnectingLocation(GetLocation("toTrain17"), LEFT);

            //toTrain17
            GetLocation("toTrain17").AddConnectingLocation(GetLocation("toCampus1"), FORWARD);
           ...
           GetLocation("Train").AddConnectingLocation(GetLocation("toTrain8"), LEFT);
			...
			//toAMDC5
			GetLocation("toAMDC5").AddConnectingLocation(GetLocation("toBurwood1"), FORWARD);
            ...
            //toBurwood1
            GetLocation("toBurwood1").AddConnectingLocation(GetLocation("toBurwood2"), LEFT);
            GetLocation("toBurwood1").AddConnectingLocation(GetLocation("toBurwood3"), RIGHT);

            //toBurwood2
            GetLocation("toBurwood2").AddConnectingLocation(GetLocation("northSide3"), FORWARD);

            //toBurwood3
            GetLocation("toBurwood3").AddConnectingLocation(GetLocation("northSide4"), FORWARD);
            ...
            GetLocation("toSouthSide2").AddConnectingLocation(GetLocation("TA Building"), LEFT);
            GetLocation("toSouthSide2").AddConnectingLocation(GetLocation("TB Building"), RIGHT);

            //toSouthSide3
            GetLocation("toSouthSide3").AddConnectingLocation(GetLocation("toSouthSide4"), FORWARD);
			GetLocation("toSouthSide3").AddConnectingLocation(GetLocation("toTATB3"), BACKWARD);

			//toSouthSide4
			GetLocation("toSouthSide4").AddConnectingLocation(GetLocation("toSouthSide5"), FORWARD);
			GetLocation("toSouthSide4").AddConnectingLocation(GetLocation("toTATB2"), BACKWARD);

			//toSouthSide5
			GetLocation("toSouthSide5").AddConnectingLocation(GetLocation("southSide3"), FORWARD);
			GetLocation("toSouthSide5").AddConnectingLocation(GetLocation("toTATB1"), BACKWARD);
			...
			//toLodges6
            GetLocation("toLodges6").AddConnectingLocation(GetLocation("toLodges7"), FORWARD);

            //toLodges7
            GetLocation("toLodges7").AddConnectingLocation(GetLocation("toLodges8"), FORWARD);


            //toLodges8
            GetLocation("toLodges8").AddConnectingLocation(GetLocation("toLodges9"), FORWARD);

            //toLodges9
            GetLocation("toLodges9").AddConnectingLocation(GetLocation("instreet17"), RIGHT);
            GetLocation("toLodges9").AddConnectingLocation(GetLocation("instreet7"), LEFT);
            ...
            GetLocation("instreet16").AddConnectingLocation(GetLocation("toLodges6"), RIGHT);
			...
			GetLocation("northSide3").AddConnectingLocation(GetLocation("northSide4"), BACKWARD);

			//northSide4
			GetLocation("northSide4").AddConnectingLocation(GetLocation("northSide3"), BACKWARD);
            GetLocation("northSide4").AddConnectingLocation(GetLocation("toAD1"), RIGHT);
			...
			//trainPark6
			GetLocation("trainPark6").AddConnectingLocation(GetLocation("toTrain7"), LEFT);
            GetLocation("trainPark6").AddConnectingLocation(GetLocation("toCampus4"), RIGHT);
